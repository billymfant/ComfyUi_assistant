...
prompt={
 ...
 "4":{"class_type":"CLIPTextEncode","inputs":{"text":"the cat wearing a tiny red wizard hat, cinematic lighting, highly detailed","clip":["2",0]}},
 "5":{"class_type":"FluxGuidance","inputs":{"conditioning":["4",0],"guidance":4.0}},
 "20":{"class_type":"LoadImage","inputs":{"image":"Cat.jpeg"}},
 "21":{"class_type":"ImageScale","inputs":{"image":["20",0],"upscale_method":"bicubic","width":1024,"height":1024,"crop":"center"}},
 "22":{"class_type":"VAEEncode","inputs":{"pixels":["21",0],"vae":["3",0]}},
 "23":{"class_type":"ReferenceLatent","inputs":{"conditioning":["5",0],"latent":["22",0]}},
 "6":{"class_type":"EmptyFlux2LatentImage","inputs":{"width":1024,"height":1024,"batch_size":1}},
 "7":{"class_type":"BasicGuider","inputs":{"model":["1",0],"conditioning":["23",0]}},
 ...
 "13":{"class_type":"SaveImage","inputs":{"images":["12",0],"filename_prefix":"FLUX2_REF_TEST"}}
}
cid=str(uuid.uuid4())
